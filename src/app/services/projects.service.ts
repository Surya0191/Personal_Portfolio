  ...
  projectsData: ProjectData[] = [
    {
      ...
      pictures: [
        'https://example.com/images/grocery1.png',
        'https://example.com/images/grocery2.png',
      ],
    },
    {
      id: 1,
      ...
      summary:
        'An application that provides weather forecasts for different cities.',
      projectDescription:
        'This app fetches weather data from an API and displays current weather conditions and forecasts for various locations.',
      projectLink: 'https://github.com/example/weather-forecast-app',
      tags: [Tag.HTML, Tag.CSS, Tag.JavaScript],
      pictures: [
        'https://example.com/images/weather1.png',
        'https://example.com/images/weather2.png',
      ],
    },
    {
      id: 2,
      ...
      summary:
        'A task management app to help organize and prioritize your tasks.',
      projectDescription:
        'This app allows users to create, edit, delete, and prioritize tasks. It also includes features for setting deadlines and reminders.',
      projectLink: 'https://github.com/example/task-manager',
      tags: [Tag.React, Tag.Redux, Tag.JavaScript],
      pictures: [
        'https://example.com/images/task1.png',
        'https://example.com/images/task2.png',
      ],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      projectDescription:
        'This app allows users to send and receive messages in real-time, with features such as group chats and media sharing.',
      projectLink: 'https://github.com/example/chat-application',
      tags: [Tag.NodeJs, Tag.JavaScript],
      pictures: [
        'https://example.com/images/chat1.png',
        'https://example.com/images/chat2.png',
      ],
    },
    {
      id: 5,
      ...
      projectDescription:
        'This app includes features like product listing, shopping cart, checkout process, and payment gateway integration.',
    ...
    },
    {
      ...
      projectDescription:
        'This app allows users to write, edit, and publish blog posts. It includes user authentication and comment sections.',
      projectLink: 'https://github.com/example/blog-platform',
      tags: [Tag.RubyOnRails, Tag.JavaScript, Tag.HTML, Tag.CSS],
      pictures: [
        'https://example.com/images/blog1.png',
    ...
    },
    {
      ...
      projectDescription:
        'This app helps users log their workouts, track their progress, and set fitness goals.',
      projectLink: 'https://github.com/example/fitness-tracker',
      tags: [Tag.ReactNative, Tag.JavaScript, Tag.CSS],
      pictures: [
        'https://example.com/images/fitness1.png',
        'https://example.com/images/fitness2.png',
      ],
    },
    {
      id: 8,
      ...
      projectDescription:
        'This app allows users to log their expenses, categorize them, and generate reports to analyze their spending habits.',
      projectLink: 'https://github.com/example/expense-tracker',
      tags: [Tag.Angular, Tag.Typescript, Tag.HTML, Tag.CSS],
      pictures: [
        'https://example.com/images/expense1.png',
        'https://example.com/images/expense2.png',
      ],
    },
    {
      id: 9,
      ...
      projectDescription:
        'This app lets users input available ingredients and find recipes that can be made with those ingredients.',
      projectLink: 'https://github.com/example/recipe-finder',
      tags: [Tag.VueJs, Tag.JavaScript, Tag.HTML, Tag.CSS],
      pictures: [
        'https://example.com/images/recipe1.png',
        'https://example.com/images/recipe2.png',
      ],
    },
  ];
